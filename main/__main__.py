...
async def start(bot, message):
  await message.reply_photo("https://te.legra.ph/file/a13b6c99ebcd96c88fdd6.jpg",caption=START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"), InlineKeyboardButton(text="Developer", url="https://xnkit.github.io/k")]]))
...
async def start_menu(_,query):
  await query.answer()
  await query.message.edit(START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"),InlineKeyboardButton(text="Developer", url="https://xnkit.github.io/k")]]))
...
async def logo_doc(_,query):
  ...
  try:
    ...
    await query.message.reply_document(link,caption="**🖼 Logo Generated By @sassy_os**")
  except FloodWait:
    pass
  except Exception as e:
    try:
